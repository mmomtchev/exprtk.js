...
addon.Expression = class Expression {
    constructor() {
        if (this.constructor == addon.Expression)
            throw new Error('Expression is an abstract base class, use the typed classes instead');
    }
};
...
for (const t of types) {
    ...
    Object.defineProperty(addon[t], 'allocator', {
        value: global[t + 'Array'],
        writable: false,
        enumerable: true
    });
    Object.defineProperty(addon[t].prototype, 'allocator', {
        value: global[t + 'Array'],
        writable: false,
        enumerable: true
    });
